...
describe('when log in', async () => {
  ...
  test('when login in, can see blog create form', async () => {
    const label = await page.getContentsOf('form label')
    expect(label).toEqual('Blog Title')
  })

  describe('and using invalid inputes', async ()=>{
    beforeEach(async() => {
  ...
  describe('and using valid inputes', async ()=>{
    beforeEach(async() => {
    ...
    test('submit then save to index page', async () => {
